...
import BasketItem from "../componnents/BasketItem";
import {clearBasket, removeBasketItem, plusBasketItem, minusBasketItem} from "../redux/action/basket";
...
const Basket = () => {
    ...
    const onRemoveItem = (id) => {
        if (window.confirm('Ви впевнені, що хочите видалити піцци ?')) {
                    ...
                    ? <div className="cart">
                        <div className="cart__top">
                            ...
                            <div className="cart__clear">
                                ...
                                <span onClick={onClearBasket}>Очистити кошик</span>
                            </div>
                        </div>
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Кількість піцц: <b>{totalCount}</b> </span>
